...
import { MobileSearchShell, MobileSearchToggleButton } from './MobileSearchShell';
...
function HeaderIconButton({ children, ...props }: React.ButtonHTMLAttributes<HTMLButtonElement>) {
  return (
    <button
      type="button"
      {...props}
