...
const MEMBER_COLUMNS = (alias: string): AllowedColumnDef[] => [
  ...
  { source: `${alias}.name_kana`, label: '氏名カナ', dataType: 'text', filterable: true, sortable: true },
  { source: `${alias}.real_name`, label: '実質名義人', dataType: 'text', filterable: true },
  { source: `${alias}.email1`, label: 'メール1', dataType: 'text', filterable: true },
  { source: `${alias}.email2`, label: 'メール2', dataType: 'text', filterable: true },
  { source: `${alias}.email3`, label: 'メール3', dataType: 'text', filterable: true },
  { source: `${alias}.phone1`, label: '電話', dataType: 'text', filterable: true },
  ...
  { source: `${alias}.ad_medium`, label: '広告媒体', dataType: 'text', filterable: true, groupable: true },
  { source: `${alias}.info_acquired_points`, label: '情報取得ポイント', dataType: 'text', filterable: true, groupable: true },
  { source: `${alias}.info_acquired_date`, label: '情報取得日', dataType: 'date', filterable: true, sortable: true },
  ...
  { source: `${alias}.referrer_name`, label: '紹介者名', dataType: 'text', filterable: true, groupable: true },
  { source: `${alias}.affiliate_id`, label: 'アフィリエイトID', dataType: 'text', filterable: true, groupable: true },
  { source: `${alias}.affiliate_name`, label: 'アフィリエイト名', dataType: 'text', filterable: true, groupable: true },
  { source: `${alias}.total_amount`, label: '総取引額', dataType: 'number', filterable: true, sortable: true, aggregatable: true },
  { source: `${alias}.total_paid_amount`, label: '総入金額', dataType: 'number', filterable: true, sortable: true, aggregatable: true },
  { source: `${alias}.total_used_amount`, label: '総利用額', dataType: 'number', filterable: true, sortable: true, aggregatable: true },
...
const APP_COLUMNS = (alias: string): AllowedColumnDef[] => [
  { source: `${alias}.id`, label: '申込ID', dataType: 'text', filterable: true, sortable: true, aggregatable: true },
  { source: `${alias}.inquiry_id`, label: '問合せID(紐付け)', dataType: 'text', filterable: true, groupable: true },
  { source: `${alias}.member_id`, label: '会員ID(紐付け)', dataType: 'text', filterable: true, groupable: true },
  { source: `${alias}.project_id`, label: '案件ID', dataType: 'number', filterable: true, groupable: true },
  ...
  { source: `${alias}.flow_type`, label: '入出金区分', dataType: 'enum', filterable: true, groupable: true },
  { source: `${alias}.owner_id`, label: '申込担当ID', dataType: 'text', filterable: true, groupable: true },
  { source: `${alias}.owner_name_raw`, label: '申込担当(元表記)', dataType: 'text', filterable: true, groupable: true },
  { source: `${alias}.acquirer_id`, label: '獲得者ID', dataType: 'text', filterable: true, groupable: true },
  { source: `${alias}.acquirer_name_raw`, label: '獲得者(元表記)', dataType: 'text', filterable: true, groupable: true },
  ...
  { source: `${alias}.scheduled_amount`, label: '予定額', dataType: 'number', filterable: true, sortable: true, aggregatable: true },
  ...
  { source: `${alias}.crypto_excluded_amount`, label: '暗号資産除外額', dataType: 'number', filterable: true, sortable: true, aggregatable: true },
  { source: `${alias}.yen_interest`, label: '円利息', dataType: 'number', filterable: true, sortable: true, aggregatable: true },
...
const INQUIRY_COLUMNS = (alias: string): AllowedColumnDef[] => [
  ...
  { source: `${alias}.member_id`, label: '紐付け会員ID', dataType: 'text', filterable: true, groupable: true },
  { source: `${alias}.name`, label: '問合せ氏名', dataType: 'text', filterable: true, sortable: true },
  { source: `${alias}.name_kana`, label: '問合せ氏名カナ', dataType: 'text', filterable: true },
  { source: `${alias}.email`, label: '問合せメール', dataType: 'text', filterable: true },
  { source: `${alias}.phone`, label: '問合せ電話', dataType: 'text', filterable: true },
  { source: `${alias}.postal_code`, label: '問合せ郵便番号', dataType: 'text', filterable: true },
  { source: `${alias}.address`, label: '問合せ住所', dataType: 'text', filterable: true },
  { source: `${alias}.ad_id`, label: '広告ID', dataType: 'text', filterable: true, groupable: true },
  { source: `${alias}.registered_at`, label: '問合せ日時', dataType: 'datetime', filterable: true, sortable: true, groupable: true },
  { source: `${alias}.created_at`, label: '作成日時', dataType: 'datetime', filterable: true, sortable: true },
  { source: `${alias}.updated_at`, label: '更新日時', dataType: 'datetime', filterable: true, sortable: true },
];
