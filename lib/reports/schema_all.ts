...
export interface AllowedColumnDef {
  ...
  dataType: DataType;
  /**
   * 表示専用の型。extra 列は SQL 上は text(dataType='text')だが、
   * 実体が数値/日付の場合に表示整形(カンマ/日付)を効かせるための型。
   * 未指定なら dataType を使う。フィルタ/SQL には影響しない。
   */
...
const MEMBER_COLUMNS = (alias: string): AllowedColumnDef[] => [
  ...
  {
    source: `${alias}.regular_contact_id`,
    label: '定期連絡者ID',
    dataType: 'text',
    filterable: true,
    groupable: true,
  ...
  {
    source: `${alias}.mailmag_registered_at`,
    label: 'メルマガ登録日時',
    dataType: 'datetime',
    filterable: true,
    sortable: true,
  ...
  {
    source: `${alias}.info_acquired_points`,
    label: '個人情報取得ポイント',
    dataType: 'text',
    filterable: true,
    groupable: true,
  ...
  {
    source: `${alias}.info_acquired_date`,
    label: '顧客情報取得日',
    dataType: 'date',
    filterable: true,
    sortable: true,
  ...
  {
    source: `${alias}.total_paid_amount`,
    label: '総合計実入金額',
    dataType: 'number',
    filterable: true,
    sortable: true,
  ...
  {
    source: `${alias}.total_used_amount`,
    label: '総利用額合計',
    dataType: 'number',
    filterable: true,
    sortable: true,
...
const APP_COLUMNS = (alias: string): AllowedColumnDef[] => [
  ...
  {
    source: `${alias}.acquirer_name_raw`,
    label: '申込獲得者',
    dataType: 'text',
    filterable: true,
    groupable: true,
  ...
  {
    source: `${alias}.contract_sent_date`,
    label: '契約書送付日',
    dataType: 'date',
    filterable: true,
    sortable: true,
  ...
  {
    source: `${alias}.scheduled_payment_date`,
    label: '入金予定日',
    dataType: 'date',
    filterable: true,
    sortable: true,
  ...
  {
    source: `${alias}.crypto_excluded_amount`,
    label: '仮想通貨除外分',
    dataType: 'number',
    filterable: true,
    sortable: true,
  ...
  {
    source: `${alias}.withdrawal_amount`,
    label: '出金額',
    dataType: 'number',
    filterable: true,
    sortable: true,
...
const ACTIVITY_COLUMNS = (alias: string): AllowedColumnDef[] => [
  ...
  {
    source: `${alias}.registered_datetime`,
    label: '対応日時',
    dataType: 'datetime',
    filterable: true,
    sortable: true,
...
export const REPORT_SCHEMAS: Record<ReportTypeId, ReportTypeSchemaDef> = {
  ...
  RT08: {
    ...
    allowedColumns: [...ACTIVITY_COLUMNS('act'), ...USER_COLUMNS('owner')],
  },
 ...
 */
export function findColumn(reportType: ReportTypeId, source: string): AllowedColumnDef | undefined {
